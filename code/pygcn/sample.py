...
class Sampler:
  ...
  def __init__(self, dataset, data_path="..\\data\\", task_type="semi"):
    ...
    (self.adj, self.train_adj, self.features, self.train_features, self.labels,
     self.idx_train, self.idx_val, self.idx_test, self.degree,
  ...
  def randomedge_sampler(self, percent, normalization, cuda):
    ...
    r_adj = sp.coo_matrix(
        (self.train_adj.data[perm],
         (self.train_adj.row[perm], self.train_adj.col[perm])),
