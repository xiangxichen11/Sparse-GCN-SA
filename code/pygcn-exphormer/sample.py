...
from data_prop import data_loader, sparse_mx_to_torch_sparse_tensor
from normalization import fetch_normalization
from utils_data import _pca
...
class Sampler:
    ...
    def randomedge_sampler(self, percent, normalization, cuda):
        ...
        optimal_components = elbow_method(explained_variance_ratio)
        
        pca_optimal = PCA(n_components=optimal_components)
        print(np.sum(pca_optimal.explained_variance_ratio_) / np.sum(pca.explained_variance_ratio_))
        fea = pca_optimal.fit_transform(fea)
        return r_adj, fea
